    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          />
          <div className="absolute left-0 bottom-full mb-2 w-64 bg-white border border-gray-200 rounded-xl shadow-xl z-20 overflow-hidden">
            <div className="p-2">
              ...
              {FIELD_TYPE_OPTIONS.map((option) => (
                <button
                  ...
                  className="w-full px-3 py-3 text-left flex items-center gap-3 hover:bg-gray-50 rounded-lg transition-colors"
                >
                  <span className={`text-2xl leading-none w-8 text-center ${option.value === 'instructions' ? 'text-amber-500' : 'text-gray-600'}`}>
                    {option.icon}
                  </span>
                  <div>
...
function PreviewPane({ label, description, fields, priorSubtasks }: PreviewPaneProps) {
  return (
    <div className="bg-gradient-to-b from-blue-50 to-gray-50 min-h-full">
      ...
      <div className="p-6 max-w-lg mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          {priorSubtasks.length > 0 && priorSubtasks.some(s => s.fields.length > 0) && (
